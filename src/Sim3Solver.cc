    ...
    pCamera1(pKF1->mpCamera), pCamera2(pKF2->mpCamera)
{
    ...
    for(int i1=0; i1<mN1; i1++)
    {
        ...
        if(vpMatched12[i1])
        {
            ...
            float sigmaSquare1 = pKF1->mvLevelSigma2[kp1.octave];
            float sigmaSquare2 = pKFm->mvLevelSigma2[kp2.octave];
            // sigmaSquare1 = 1;
            // sigmaSquare2 = 1;
...
Eigen::Matrix4f Sim3Solver::iterate(int nIterations, bool &bNoMore, vector<bool> &vbInliers, int &nInliers, bool &bConverge)
{
    ...
    if(N<mRansacMinInliers)
    {
        //cout<<"N: "<<N<<" mRansacMinInliers:"<<mRansacMinInliers<<endl;
        bNoMore = true;
        return Eigen::Matrix4f::Identity();
    }
    ...
    if(mnIterations>=mRansacMaxIts)
    {
        //cout<<"mnIterations: "<<mnIterations<<"mRansacMaxIts: "<<mRansacMaxIts<<endl;
        bNoMore=true;
    }
