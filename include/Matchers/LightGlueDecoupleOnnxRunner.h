...
private:
    ...
    int Matcher_Inference(Configuration cfg , std::vector<cv::KeyPoint> kpts0 , std::vector<cv::KeyPoint> kpts1 , float* desc0 , float* desc1);
    
    int Matcher_PostProcess(Configuration cfg , std::vector<cv::Point2f> kpts0 , std::vector<cv::Point2f> kpts1);
    int Matcher_PostProcess_fused(Configuration cfg , std::vector<cv::Point2f> kpts0 , std::vector<cv::Point2f> kpts1);
public:
